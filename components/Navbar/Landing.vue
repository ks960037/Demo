      ...
      <div class="col-12">
        ...
        >
          <div class="container-fluid px-0">
            ...
            <select
              class="btn btn-sm btn-round mb-0 ms-auto d-lg-none d-block"
            ...
            <nuxt-link
              to="/login"
              class="btn btn-sm bg-gradient-primary btn-round mb-0 d-lg-none d-block"
              >{{ $t("login") }}</nuxt-link
            >
            <div id="navigation" class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0">
              ...
              <ul class="navbar-nav d-lg-flex d-none">
                <select
                  class="mb-0 btn btn-sm btn-round"
                  style="padding: 0 10px; height: 36px; line-height: 36px"
                  v-model="locale"
                >
                  <option value="en">en</option>
