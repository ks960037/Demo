<template>
  <div class="card h-100">
    ...
    <div class="p-3 card-body">
      <div class="row">
        <div class="text-center col-lg-6 col-12 d-flex flex-column align-items-center justify-content-center">
          <div class="chart">
            <chartsDoughnutChart width="250" :chart-options="{
              chart: {
                type: 'donut',
              },
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <div class="px-2 py-1 d-flex">
                      <div>
                        <img src="@/assets/img/small-logos/logo-atlassian.svg" class="avatar avatar-sm me-2"
                          alt="logo_atlassian" />
                      </div>
                      <div class="d-flex flex-column justify-content-center">
